...
### 01. Enable Flagship Edge Ligthining+ Animations in Q (Needs OneUI 2.x)
Search for the following line in floating_feature.xml:
```
...
### 02. Enable Flagship Edge Ligthining+ Animations in R (Needs OneUI 3.x)
```
...
### 02. Change Device Name to Your Choosed one
Search for the following line in floating_feature.xml:
```
...
### 11. Enable custom values for Status Bar and QS panel
...
### 14. Enable Game Launcher in Drawer
```
...
### 15. Enable Google Discover in Drawer (Needs OneUI 3.x)
```
